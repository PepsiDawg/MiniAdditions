package io.github.pepsidog.miniadditions.additions.featherplucker;
    ...
    public void onEntityDamageByEntity(final EntityDamageByEntityEvent event) {
        ...
        if (damaged.getType() == EntityType.CHICKEN) {
            ...
            if (!container.has(this.key, PersistentDataType.BYTE)) {
                ...
                Bukkit.getScheduler().scheduleSyncDelayedTask(this.plugin, () -> container.remove(this.key), this.cooldown);
            }
        }
    }
}
